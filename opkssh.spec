...
Source0:        %{gosource}
# Generated by go-vendor-tools
# Use the archive hosted on Fedora People to allow COPR builds. This will be replaced once the package is in Fedora.
#Source1:        %{archivename}-vendor.tar.bz2
Source1:        https://thofmann.fedorapeople.org/opkssh/%{archivename}-vendor.tar.bz2
